    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'format' => 'raw',
                'value' => function ($model) {
                    return isset(\backend\models\Article::$statuses[$model->status])
                        ? \backend\models\Article::$statuses[$model->status]
                        : ($model->status ? $model->status : '');
                },
                'filter' => Html::activeDropDownList($searchModel, 'status', \backend\models\Article::$statuses, ['class'=>'form-control', 'prompt' => '']),
            ],
